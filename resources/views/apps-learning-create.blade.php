...
@section('title')
@lang('translation.create-course')
@endsection
@section('css')
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="coursesDetails" role="tabpanel" aria-labelledby="coursesDetails-tab">
                            ...
                            <div class="row g-3 align-items-center">
                                ...
                                <div class="col-lg-6">
                                    <div>
                                        ...
                                        <select class="form-select" id="lavel-input" data-choices data-choices-search-false multiple>
                                ...
                                <div class="col-lg-6">
                                    <div>
                                        ...
                                        <select class="form-select" id="language-input" data-choices data-choices-search-false multiple>
                            ...
                            <div class="d-flex align-items-start gap-3 mt-4">
                                <button type="button" class="btn btn-primary btn-label right ms-auto nexttab nexttab" data-nexttab="pills-info-desc-tab"><i class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i> Next Step</button>
                            </div>
                        </div>
                        <!-- end tab pane -->
                        ...
                        <div class="tab-pane fade" id="pills-info-desc" role="tabpanel" aria-labelledby="pills-info-desc-tab">
                            ...
                            <div class="d-flex align-items-start gap-3 mt-4">
                                <button type="button" class="btn btn-link text-decoration-none btn-label previestab" data-previous="coursesDetails-tab"><i class="ri-arrow-left-line label-icon align-middle fs-lg me-2"></i> Back to Course Details</button>
                                <button type="button" class="btn btn-primary btn-label right ms-auto nexttab nexttab" data-nexttab="pills-success-tab"><i class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Submit</button>
                            </div>
                        </div>
                        <!-- end tab pane -->
                        ...
                        <div class="tab-pane fade" id="pills-success" role="tabpanel" aria-labelledby="pills-success-tab">
                            <div>
                                <div class="text-center">
                                    <div class="my-4">
                                        <img src="{{ URL::asset('build/images/success-img.png') }}" alt="" height="150">
                                    </div>
                                    <h4>Well Done !</h4>
...
<script src="{{ URL::asset('build/js/pages/learning-create.init.js') }}"></script>
