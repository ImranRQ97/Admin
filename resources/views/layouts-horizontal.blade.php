                    ...
                    <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                        ...
                        <tbody class="list">
                            <tr>
                                ...
                                <td class="order_id">
                                    <a href="apps-ecommerce-order-overview" class="fw-medium link-primary">#TBS250011</a>
                                </td>
                                <td class="shop">
                                    <img src="{{ URL::asset('build/images/companies/img-7.png') }}" alt="" class="avatar-xxs rounded-circle">
                                </td>
                                <td class="customer">
                                    Alex Smith
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="order_id">
                                    <a href="apps-ecommerce-order-overview" class="fw-medium link-primary">#TBS250010</a>
                                </td>
                                <td class="shop">
                                    <img src="{{ URL::asset('build/images/companies/img-1.png') }}" alt="" class="avatar-xxs rounded-circle">
                                </td>
                                <td class="customer">
                                    Jansh Brown
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="order_id">
                                    <a href="apps-ecommerce-order-overview" class="fw-medium link-primary">#TBS250009</a>
                                </td>
                                <td class="shop">
                                    <img src="{{ URL::asset('build/images/companies/img-2.png') }}" alt="" class="avatar-xxs rounded-circle">
                                </td>
                                <td class="customer">
                                    Ayaan Bowen
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="order_id">
                                    <a href="apps-ecommerce-order-overview" class="fw-medium link-primary">#TBS250008</a>
                                </td>
                                <td class="shop">
                                    <img src="{{ URL::asset('build/images/companies/img-3.png') }}" alt="" class="avatar-xxs rounded-circle">
                                </td>
                                <td class="customer">
                                    Prezy Mark
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="order_id">
                                    <a href="apps-ecommerce-order-overview" class="fw-medium link-primary">#TBS250007</a>
                                </td>
                                <td class="shop">
                                    <img src="{{ URL::asset('build/images/companies/img-4.png') }}" alt="" class="avatar-xxs rounded-circle">
                                </td>
                                <td class="customer">
                                    Vihan Hudda
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="order_id">
                                    <a href="apps-ecommerce-order-overview" class="fw-medium link-primary">#TBS250006</a>
                                </td>
                                <td class="shop">
                                    <img src="{{ URL::asset('build/images/companies/img-5.png') }}" alt="" class="avatar-xxs rounded-circle">
                                </td>
                                <td class="customer">
                                    Vihan Hudda
                                </td>
                    ...
                    <div class="vstack gap-2">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm flex-shrink-0">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="{{ URL::asset('build/images/products/img-1.png') }}" alt="" class="avatar-xs">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#!">
                        ...
                        <div class="p-2 border border-dashed">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm flex-shrink-0">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="{{ URL::asset('build/images/products/img-2.png') }}" alt="" class="avatar-xs">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#!">
                        ...
                        <div class="p-2 border border-dashed">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm flex-shrink-0">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="{{ URL::asset('build/images/products/img-3.png') }}" alt="" class="avatar-xs">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#!">
                        ...
                        <div class="p-2 border border-dashed">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm flex-shrink-0">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="{{ URL::asset('build/images/products/img-4.png') }}" alt="" class="avatar-xs">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#!">
                        ...
                        <div class="p-2 border border-dashed">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm flex-shrink-0">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="{{ URL::asset('build/images/products/img-5.png') }}" alt="" class="avatar-xs">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#!">
                ...
                <div class="row g-0">
                    <div class="col-lg-5">
                        <div class="bg-primary-subtle p-5 h-100">
                            <div class="p-lg-4">
                                <img src="{{ URL::asset('build/images/products/img-3.png') }}" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <!--end col-->
