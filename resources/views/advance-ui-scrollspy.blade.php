                ...
                <div class="live-preview">
                    <nav id="navbar-example" class="navbar navbar-light bg-light px-3">
                        <a class="navbar-brand mb-2 mb-sm-0" href="#">
                            <img src="{{ URL::asset('build/images/logo-dark.png') }}" class="card-logo card-logo-dark" alt="logo dark" height="22">
                            <img src="{{ URL::asset('build/images/logo-light.png') }}" class="card-logo card-logo-light" alt="logo light" height="22">
                        </a>
                        ...
                        <div class="col-xxl-3">
                            <nav id="navbar-examplenested" class="navbar navbar-light bg-light flex-column">
                                ...
                                <nav class="nav nav-pills flex-column p-3 w-100">
                                    <a class="nav-link" href="#item-1"><i class="ri-dashboard-2-line align-middle me-2 fs-lg"></i> <span>Dashboards</span></a>
                                    <nav class="nav nav-pills flex-column">
                                        <a class="nav-link" href="#item-1-1"><i class="ri-subtract-fill align-middle me-2 fs-base"></i> <span>Ecommerce</span></a>
                                        <a class="nav-link" href="#item-1-2"><i class="ri-subtract-fill align-middle me-2 fs-base"></i> <span>Analytics</span></a>
                                    </nav>
                                    <a class="nav-link active" href="#item-2"><i class="ri-pencil-ruler-2-line align-middle me-2 fs-lg"></i> <span>Base UI</span></a>
                                    <a class="nav-link" href="#item-3"><i class="ri-apps-2-line align-middle me-2 fs-lg"></i> <span>Apps</span></a>
                                    <nav class="nav nav-pills flex-column">
                                        <a class="nav-link" href="#item-3-1"><i class="ri-subtract-fill align-middle me-2 fs-base"></i> <span>Chat</span></a>
                                        <a class="nav-link" href="#item-3-2"><i class="ri-subtract-fill align-middle me-2 fs-base"></i> <span>Email</span></a>
                                    </nav>
                                </nav>
                            </nav>
                        </div>
