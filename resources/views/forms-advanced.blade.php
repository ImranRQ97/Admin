                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <div class="input-group" data-input-flag>
                                <button class="btn btn-light border" type="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="{{ URL::asset('build/images/flags/us.svg') }}" alt="flag img" height="20" class="country-flagimg rounded"><span class="ms-2 country-codeno">+ 1</span></button>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        <div>
                            <h5 class="fs-md mb-1">Basic Example</h5>
                    ...
                    <div class="col-lg-6">
                        <div class="mt-4 mt-lg-0">
                            <h5 class="fs-md mb-1">Headers</h5>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mt-4">
                            <h5 class="fs-md mb-1">Option Groups</h5>
