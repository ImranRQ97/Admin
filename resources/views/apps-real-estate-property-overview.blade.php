...
@section('title')
@lang('translation.property-overview')
@endsection
@section('css')
                        ...
                        <div class="row">
                            <div class="col-xl-9 col-lg-8">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div class="position-relative ribbon-box">
                                                        <div class="ribbon ribbon-danger fw-medium rounded-end mt-2"> For Sale</div>
                                                        <div class="dropdown position-absolute top-0 end-0 m-3">
                                                            <button class="btn bg-white avatar-xs p-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                        ...
                                                        <img src="{{ URL::asset('build/images/real-estate/overview-02.jpg') }}" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="position-relative ribbon-box">
                                                        <div class="ribbon ribbon-primary fw-medium rounded-end mt-2"> Front View</div>
                                                        <div class="dropdown position-absolute top-0 end-0 m-3">
                                                            <button class="btn bg-white avatar-xs p-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                                <i class="bi bi-share"></i>
                                                            </button>
                                                        ...
                                                        <img src="{{ URL::asset('build/images/real-estate/overview-01.jpg') }}" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="swiper-slide">
                                                <div class="position-relative ribbon-box">
                                                    ...
                                                    <img src="{{ URL::asset('build/images/real-estate/overview-03.jpg') }}" alt="" class="img-fluid">
                                                </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="pt-1">
                                            ...
                                            <h6 class="card-title">Swimming Pool Side Of The Residential Ascot Home</h6>
                                            <div class="text-muted hstack gap-2 flex-wrap list-unstyled mb-3">
                                                <div>
                                                    <i class="bi bi-geo-alt align-baseline me-1"></i> Birmingham, West Midlands, United Kingdom
                                                </div>
                                                <div class="vr"></div>
                                                <div>
                                            ...
                                            <p class="text-muted">Basic Property Unit. Definition. The basic unit of ownership that is recorded in the land books, land registers or equivalent. It is defined by unique ownership and homogeneous real property rights, and may consist of one or more adjacent or geographically separate parcels.</p>
                                        </div>
                                                ...
                                                <div class="col-xl-3 col-sm-6">
                                                    <div class="p-3 border border-dashed rounded">
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <p class="fs-md mb-0">$7000 - $8000</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-sm-6">
                                                    <div class="p-3 border border-dashed rounded">
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <p class="fs-md mb-0">4 Bedroom</p>
                                                        </div>       
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-sm-6">
                                                    <div class="p-3 border border-dashed rounded">
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <p class="fs-md mb-0">3 Bathroom</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-sm-6">
                                                ...
                                                <div class="col-xl-3 col-sm-6">
                                                    <div class="p-3 border border-dashed rounded">
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <p class="fs-md mb-0">1324 SQFT</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-sm-6">
                                                    <div class="p-3 border border-dashed rounded">
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="avatar-xs flex-shrink-0">
                                                                <div class="avatar-title bg-secondary-subtle text-secondary fs-lg rounded">
                                                                    <i class="bi bi-map"></i>
                                                                </div>
                                                            </div>
                                                            <p class="fs-md mb-0">United Kingdom</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-3 col-sm-6">
                                                    <div class="p-3 border border-dashed rounded">
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <p class="fs-md mb-0">Residency</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div id="leaflet-map-group-control" class="leaflet-map leaflet-gray" style="min-height: 100%;"></div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card card-primary text-center">
                                            <div class="card-body">
                                                <h4 class="text-reset fw-normal">$7000 - $8000</h4>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="text-center">
                                                    ...
                                                    <p class="text-muted mb-4">73 Alum Rock Rd, Birmingham, West Midland, United Kingdom - s B8 1LY</p>
                                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <a href="#!" class="float-end link-effect">View More <i class="bi bi-arrow-right align-baseline ms-1"></i></a>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-title mb-0">Owner History</h4>
                                            </div>
                                            <div class="card-body">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        <div class="flex-shrink-0">
                                                                            <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" alt="" class="avatar-sm rounded-circle p-1">
                                                                        </div>
                                                                        <div class="flex-grow-1">
                                                                            <h6 class="fs-md mb-1">Jerry Emard</h6>
                                                                            <p class="text-muted mb-0">03 Nav, 2022 - Present</p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="text-end">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        <div class="flex-shrink-0">
                                                                            <img src="{{ URL::asset('build/images/users/avatar-7.jpg') }}" alt="" class="avatar-sm rounded-circle p-1">
                                                                        </div>
                                                                        <div class="flex-grow-1">
                                                                            <h6 class="fs-md mb-1">Sonia Conn</h6>
                                                                            <p class="text-muted mb-0">24 March, 2022 - 03 Nav, 2022</p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="text-end">
                                                                    <p class="fs-md mb-0 text-muted"><i class="bi bi-star-half text-warning align-baseline me-1"></i> 4.8</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        <div class="flex-shrink-0">
                                                                            <img src="{{ URL::asset('build/images/users/avatar-4.jpg') }}" alt="" class="avatar-sm rounded-circle p-1">
                                                                        </div>
                                                                        <div class="flex-grow-1">
                                                                            <h6 class="fs-md mb-1">Talon Bradtke</h6>
                                                                            <p class="text-muted mb-0">27 Aug, 2021 - 24 March, 2022</p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="text-end">
                                                                    <p class="fs-md mb-0 text-muted"><i class="bi bi-star-half text-warning align-baseline me-1"></i> 4.4</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        <div class="flex-shrink-0">
                                                                            <img src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" alt="" class="avatar-sm rounded-circle p-1">
                                                                        </div>
                                                                        <div class="flex-grow-1">
                                                                            <h6 class="fs-md mb-1">Tyrell Kerluke</h6>
                                                                            <p class="text-muted mb-0">09 June, 2019 - 27 Aug, 2021</p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="text-end">
                                                                    <p class="fs-md mb-0 text-muted"><i class="bi bi-star-half text-warning align-baseline me-1"></i> 4.6</p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
...
<script src="{{ URL::asset('build/js/pages/real-estate-property-overview.init.js') }}"></script>
