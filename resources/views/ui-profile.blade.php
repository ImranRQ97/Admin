                    ...
                    <div class="card-body pt-0">
                        <div class="row justify-content-between gy-4">
                            <div class="col-xl-5 col-md-7">
                                <h5 class="fs-xl">Edward Diana</h5>
                                ...
                                <div class="hstack gap-2">
                                    ...
                                    <button type="button" class="btn btn-subtle-info btn-icon"><i class="bi bi-chat-left-text"></i></button>
                                    <div class="dropdown">
                                        <button class="btn btn-subtle-danger btn-icon" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="col-xl-3 col-md-5">
                                ...
                                <div>
                                    ...
                                    <ul class="d-flex gap-2 flex-wrap list-unstyled mb-0">
                                        <li>
                                            <span class="badge bg-secondary-subtle text-secondary">Business Marketing</span>
                                        </li>
                                        <li>
                                            <span class="badge bg-secondary-subtle text-secondary">Google Ads Management</span>
                                        </li>
                                        <li>
                                            <span class="badge bg-secondary-subtle text-secondary">Social Ads Management</span>
                                        </li>
                                        <li>
                                            <span class="badge bg-secondary-subtle text-secondary">Content SEO</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
