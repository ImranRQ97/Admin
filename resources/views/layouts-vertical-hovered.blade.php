                        ...
                        <tbody class="list">
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ URL::asset('build/images/users/32/avatar-2.jpg') }}" alt="react.png" class="avatar-xxs rounded">
                            ...
                            <tr>
                                <td class="contact_name">
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ URL::asset('build/images/users/32/avatar-3.jpg') }}" alt="shopify.png" class="avatar-xxs rounded">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ URL::asset('build/images/users/32/avatar-5.jpg') }}" alt="sketch.png" class="avatar-xxs rounded">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ URL::asset('build/images/users/32/avatar-6.jpg') }}" alt="sketch.png" class="avatar-xxs rounded">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ URL::asset('build/images/users/32/avatar-7.jpg') }}" alt="sketch.png" class="avatar-xxs rounded">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ URL::asset('build/images/users/32/avatar-8.jpg') }}" alt="sketch.png" class="avatar-xxs rounded">
                                        <a href="pages-profile" class="text-reset contact_name">Buck Roberts</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ URL::asset('build/images/users/32/avatar-9.jpg') }}" alt="sketch.png" class="avatar-xxs rounded">
                ...
                <div data-simplebar class="card-body py-0" style="max-height: 350px;">
                    <div class="vstack gap-2">
                        ...
                        <div class="py-2 px-3 border border-dashed rounded">
                            <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/users/48/avatar-9.jpg') }}" alt="" class="avatar-sm rounded">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
                        ...
                        <div class="py-2 px-3 border border-dashed rounded">
                            <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/users/48/avatar-8.jpg') }}" alt="" class="avatar-sm rounded">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
                        ...
                        <div class="py-2 px-3 border border-dashed rounded">
                            <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/users/48/avatar-7.jpg') }}" alt="" class="avatar-sm rounded">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
                        ...
                        <div class="py-2 px-3 border border-dashed rounded">
                            <div class="d-flex align-items-center gap-2">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/users/48/avatar-6.jpg') }}" alt="" class="avatar-sm rounded">
                                </div>
                                <div class="flex-grow-1 overflow-hidden">
