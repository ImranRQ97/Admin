                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item carousel-item-next carousel-item-start">
                            <img class="d-block img-fluid mx-auto" src="{{ URL::asset('build/images/small/img-1.jpg') }}" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid mx-auto" src="{{ URL::asset('build/images/small/img-2.jpg') }}" alt="Second slide">
                        </div>
                        <div class="carousel-item active carousel-item-start">
                            <img class="d-block img-fluid mx-auto" src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="Third slide">
                        </div>
                    </div>
                </div>
            </div><!-- end card-body -->
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img class="d-block img-fluid mx-auto" src="{{ URL::asset('build/images/small/img-4.jpg') }}" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid mx-auto" src="{{ URL::asset('build/images/small/img-5.jpg') }}" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid mx-auto" src="{{ URL::asset('build/images/small/img-6.jpg') }}" alt="Third slide">
                        </div>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item">
                            <img class="d-block img-fluid mx-auto" src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid mx-auto" src="{{ URL::asset('build/images/small/img-2.jpg') }}" alt="Second slide">
                        </div>
                        <div class="carousel-item active">
                            <img class="d-block img-fluid mx-auto" src="{{ URL::asset('build/images/small/img-1.jpg') }}" alt="Third slide">
                        </div>
                    </div>
            ...
            <div class="card-body bg-light border-bottom border-top bg-opacity-25 d-flex align-items-center">
                <h5 class="flex-grow-1 fs-xs text-muted mb-0">HTML Preview</h5>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div id="carouselExampleCaption" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item">
                            <img src="{{ URL::asset('build/images/small/img-7.jpg') }}" alt="" class="d-block img-fluid mx-auto">
                        ...
                        <div class="carousel-item active">
                            <img src="{{ URL::asset('build/images/small/img-2.jpg') }}" alt="" class="d-block img-fluid mx-auto">
                            <div class="carousel-caption text-white-50">
                        ...
                        <div class="carousel-item">
                            <img src="{{ URL::asset('build/images/small/img-9.jpg') }}" alt="" class="d-block img-fluid mx-auto">
                            <div class="carousel-caption text-white-50">
...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <pre class="language-markup" style="height: 330px;"><code>&lt;!-- With Crossfade Animation --&gt;
&lt;div id=&quot;carouselExampleFade&quot; class=&quot;carousel slide carousel-fade&quot; data-ride=&quot;carousel&quot;&gt;
   &lt;div class=&quot;carousel-indicators&quot;&gt;
        &lt;button type=&quot;button&quot; data-bs-target=&quot;#carouselExampleFade&quot; data-bs-slide-to=&quot;0&quot; class=&quot;active&quot; aria-current=&quot;true&quot; aria-label=&quot;Slide 1&quot;&gt;&lt;/button&gt;
        &lt;button type=&quot;button&quot; data-bs-target=&quot;#carouselExampleFade&quot; data-bs-slide-to=&quot;1&quot; aria-label=&quot;Slide 2&quot;&gt;&lt;/button&gt;
...
&lt;/div&gt;
    ...
    <div class="col-xl-6">
        <div class="card">
                ...
                <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="10000">
                            <img src="{{ URL::asset('build//images/small/img-12.jpg') }}" class="d-block w-100" alt="First slide">
                        </div>
                        <div class="carousel-item" data-bs-interval="2000">
                            <img src="{{ URL::asset('build/images/small/img-11.jpg') }}" class="d-block w-100" alt="two slide">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ URL::asset('build/images/small/img-10.jpg') }}" class="d-block w-100" alt="There slide">
                        </div>
                    </div>
            ...
            <div class="card-body">
                <pre class="language-markup" style="height: 310px;"><code>&lt;!-- Individual Slide --&gt;
&lt;div id=&quot;carouselExampleInterval&quot; class=&quot;carousel slide&quot; data-bs-ride=&quot;carousel&quot;&gt;
&lt;div class=&quot;carousel-inner&quot;&gt;
  &lt;div class=&quot;carousel-item active&quot; data-bs-interval=&quot;10000&quot;&gt;
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ URL::asset('build/images/small/img-9.jpg') }}" class="d-block w-100" alt="One Slide">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ URL::asset('build/images/small/img-8.jpg') }}" class="d-block w-100" alt="Two Slide">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ URL::asset('build/images/small/img-7.jpg') }}" class="d-block w-100" alt="Three Slide">
                        </div>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="10000">
                            <img src="{{ URL::asset('build/images/small/img-4.jpg') }}" class="d-block w-100" alt="One Slide">
                        ...
                        <div class="carousel-item" data-bs-interval="2000">
                            <img src="{{ URL::asset('build/images/small/img-5.jpg') }}" class="d-block w-100" alt="Two Slide">
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="carousel-item">
                            <img src="{{ URL::asset('build/images/small/img-6.jpg') }}" class="d-block w-100" alt="Three Slide">
                            <div class="carousel-caption d-none d-md-block">
            ...
            <div class="card-body">
                <pre class="language-markup" style="height: 350px;">
<code>&lt;!-- Dark Variant --&gt;
&lt;div id=&quot;carouselExampleDark&quot; class=&quot;carousel carousel-dark slide&quot; data-bs-ride=&quot;carousel&quot;&gt;
&lt;div class=&quot;carousel-indicators&quot;&gt;
  &lt;button type=&quot;button&quot; data-bs-target=&quot;#carouselExampleDark&quot; data-bs-slide-to=&quot;0&quot; class=&quot;active&quot; aria-current=&quot;true&quot; aria-label=&quot;Slide 1&quot;&gt;&lt;/button&gt;
