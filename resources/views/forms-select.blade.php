...
@slot('title')Form Select @endslot
@endcomponent
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <pre class="language-markup" style="height:250px;">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-lg-0">Menu Size</h4>
            </div><!-- end card header -->
            <div class="card-body">
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Select Size</h4>
            </div><!-- end card header -->
            <div class="card-body">
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <div>
                    <div>
                        <h5 class="fs-md mb-3">Single select input Example</h5>
                    ...
                    <div class="mt-4">
                        <h5 class="fs-md mb-3">Multiple select input</h5>
                    ...
                    <div class="mt-4">
                        <h5 class="fs-md mb-3">Text inputs</h5>
