...
<div class="chat-wrapper d-lg-flex gap-1 p-1 mb-3">
    <div class="chat-wrapper-menu p-3 d-flex flex-column rounded">
        <div class="mb-3 position-relative d-none d-lg-block">
            <a href="#!"><img src="{{ URL::asset('build/images/users/48/avatar-1.jpg') }}" alt="" class="avatar-sm rounded"></a>
                        ...
                        <ul class="list-unstyled chat-list">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="chat-user-img flex-shrink-0 me-2">
                                        <div class="avatar-xxs">
                                            <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="rounded-circle img-fluid" alt="">
                                        </div>
                                    </div>
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="chat-user-img flex-shrink-0 me-2">
                                        <div class="avatar-xxs">
                                            <img src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" class="rounded-circle img-fluid" alt="">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a href="#!" class="p-0">
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="chat-user-img flex-shrink-0 me-2">
                                        <div class="avatar-xxs">
                                            <img src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" class="rounded-circle img-fluid" alt="">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a href="#!" class="p-0">
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="chat-user-img flex-shrink-0 me-2">
                                        <div class="avatar-xxs">
                                            <img src="{{ URL::asset('build/images/users/avatar-6.jpg') }}" class="rounded-circle img-fluid" alt="">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a href="#!" class="p-0">
                            ...
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="chat-user-img flex-shrink-0 me-2">
                                        <div class="avatar-xxs">
                                            <img src="{{ URL::asset('build/images/users/avatar-8.jpg') }}" class="rounded-circle img-fluid" alt="">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 overflow-hidden">
                                        <a href="#!" class="p-0">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 chat-user-img online user-own-img align-self-center me-3 ms-0">
                                        <img src="{{ URL::asset('build/images/users/32/avatar-2.jpg') }}" class="rounded-circle avatar-xs" alt="">
                ...
                <div class="row g-3">
                    <div class="col-lg-9">
                        <div class="position-relative">
                            <a href="#!">
                                <img src="{{ URL::asset('build/images/chat-user.jpeg') }}" alt="" class="object-fit-cover w-100 rounded" height="515">
                            </a>
                    ...
                    <div class="col-lg-3">
                        <div class="row g-3">
                            <div class="col-lg-12">
                                <div class="position-relative">
                                    <a href="#!">
                                        <img src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" alt="" class="w-100 object-fit-cover rounded" height="250">
                                    </a>
                                </div>
                            </div>
                            <!--end col-->
                            <div class="col-lg-12">
                                <div class="position-relative">
                                    <a href="#!">
                                        <img src="{{ URL::asset('build/images/users/avatar-7.jpg') }}" alt="" class="w-100 object-fit-cover rounded" height="250">
                                    </a>
                                </div>
                            </div>
                            <!--end col-->
