                                ...
                                <div class="card-body py-5 d-flex justify-content-between flex-column h-100">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    Welcome to <span class="text-primary ms-1">FinAnalyz</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <p class="text-white opacity-75 mb-0 mt-3">
                                            ...
                                            </script> Finanalyz. Crafted with <i class="mdi mdi-heart text-danger"></i>
                                            by Themesbrand
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-sm-5 m-lg-4">
                                    ...
                                    <div class="p-2 mt-5">
                                        <form class="needs-validation" novalidate method="POST"
                                            ...
                                            <div class="mb-2">
                                                <label for="userpassword_confirmation" class="form-label">Confirm
                                            ...
                                            <div class="mb-4">
                                                <p class="mb-0 fs-xs text-muted fst-italic">By registering you agree
                                                    to
