                                ...
                                <div class="card-body py-5 d-flex justify-content-between flex-column h-100">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="effect-circle-2 position-relative mx-auto rounded-circle d-flex align-items-center justify-content-center"
                                                style="background-image: url('{{ URL::asset('build/images/fin-logo.jpg') }}'); background-size: cover; background-position: center;">
                                                >
                                                <div
                                    ...
                                    <div class="text-center">
                                        <p class="text-white opacity-75 mb-0 mt-3">
                                            ...
                                            </script> Finanalyaz. Crafted with <i
                            ...
                            <div class="card mb-0 border-0 shadow-none mb-0">
                                <div class="card-body p-sm-5 m-lg-4">
                                    <div class="text-center mt-2">
                                        ...
                                        <p class="text-muted">Get your FinAnalyaz account now</p>
                                    </div>
                                    <div class="p-2 mt-5">
                                        <form class="needs-validation" novalidate method="POST"
                                            ...
                                            <div class="mb-3">
                                                <label for="gstin" class="form-label">GSTIN <span
                                                        class="text-danger">*</span></label>
                                                <input type="text"
                                                    class="form-control @error('gstin') is-invalid @enderror" id="gstin"
                                                    name="gstin" value="{{ old('gstin') }}"
                                                    placeholder="Enter your GSTIN" required>
                                                @error('gstin')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
