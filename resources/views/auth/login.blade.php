                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <!-- <div
                                                    ...
                                                    Welcome to -->
                                                <span class="logo-lg">
                                                    <!-- <img src="{{ URL::asset('build/images/fin-logo.jpg') }}" alt=""
                                                            height="60"> -->
                                                    <!-- </span><span class="text-primary ms-1">FinAnalyaz</span> -->
                                                    <!-- </div> -->
                                            </div>
                                        </div>
                            ...
                            <div class="card mb-0 border-0 shadow-none mb-0">
                                <div class="card-body p-sm-5 m-lg-4">
                                    <div class="text-center mt-5">
                                        ...
                                        <p class="text-muted">Sign in to continue to FinAnalyaz.</p>
                                    </div>
                                    <div class="p-2 mt-5">
