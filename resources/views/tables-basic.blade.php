    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Default Table</h4>
            </div><!-- end card header -->
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Tables Colors</h4>
            </div><!-- end card header -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="hstack gap-3 flex-wrap">
                                                <a href="javascript:void(0);" class="link-success fs-base"><i class="ri-edit-2-line"></i></a>
                                                <a href="javascript:void(0);" class="link-danger fs-base"><i class="ri-delete-bin-line"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Hoverable Rows</h4>
            </div><!-- end card header -->
                            ...
                            <table class="table table-hover align-middle table-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Cleo Carson</td>
                                        <td>$4,521</td>
                                        <td><a href="javascript:void(0);"><i class="ri-download-2-line fs-xl lh-1 align-middle"></i></a></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                            <div class="form-check">
...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Active Tables</h4>
            </div><!-- end card header -->
...
&lt;/table&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Bordered Tables</h4>
            </div><!-- end card header -->
...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Tables Border Colors</h4>
            </div><!-- end card header -->
            <div class="card-body">
...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Small Tables</h4>
            </div><!-- end card header -->
...
&lt;/table&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Table Head</h4>
            </div><!-- end card header -->
...
&lt;/table&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Captions</h4>
            </div><!-- end card header -->
...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Table Nesting</h4>
            </div><!-- end card header -->
...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Vertical alignment</h4>
            </div><!-- end card header -->
