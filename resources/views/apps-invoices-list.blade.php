                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex mb-4 pb-1">
                                        <div class="flex-grow-1">
                                            <h6 class="card-title">Total Receivables <i class="bi bi-exclamation-circle align-baseline ms-1 fs-sm" data-bs-toggle="tooltip" data-bs-title="Once you send an invoice (or bill), it becomes part of your accounts receivable – until it's paid."></i></h6>
                                            <p class="text-muted mb-0"><b>$985.32k</b> Total unpaid invoices</p>
                                        </div>
                                        <div class="flex-shrink-0">
                                            <a href="apps-ecommerce-seller-overview" class="link-effect">View Profile <i class="bi bi-arrow-right align-baseline ms-1"></i></a>
                                        </div>
                                    </div>
