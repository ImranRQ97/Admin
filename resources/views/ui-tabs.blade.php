                        ...
                        <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                <div class="d-flex mb-2">
                                    <div class="flex-shrink-0">
                                        <img src="{{ URL::asset('build/images/small/img-4.jpg') }}" alt="" width="150" class="rounded">
                                    </div>
            ...
            <div class="card-body">
                ...
                <div class="tab-content text-muted">
                    <div class="tab-pane active" id="home2" role="tabpanel">
                        <p class="flex-grow-1 mb-0"><img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" alt="" class="avatar-lg rounded float-start me-3">
                    ...
                    <div class="tab-pane active" id="home1" role="tabpanel">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 ms-2">
                                ...
                                <div class="mt-2">
                                    <a href="javascript:void(0);" class="btn btn-sm btn-subtle-primary">Read More <i class="ri-arrow-right-line ms-1 align-middle"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 fs-md">Dominic Charlton</h6>
                                ...
                                <div class="d-flex mt-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 fs-md">Charlie Pritchard</h6>
                                ...
                                <div class="d-flex mt-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 fs-md">Harvey Wells</h6>
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex mt-3 mt-sm-0">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 fs-md">Amelie Townsend</h6>
                                ...
                                <div class="d-flex mt-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 fs-md">Emily Slater</h6>
                                ...
                                <div class="d-flex mt-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 fs-md">Declan Long</h6>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 fs-md">Luke Brown</h6>
                                ...
                                <div class="d-flex mt-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 fs-md">Matilda Walker</h6>
                                ...
                                <div class="d-flex mt-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 fs-md">Leo Stokes</h6>
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex mt-3 mt-sm-0">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 fs-md">Chelsea Preston</h6>
                                ...
                                <div class="d-flex mt-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 fs-md">Jennifer Barker</h6>
                                ...
                                <div class="d-flex mt-3">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 fs-md">Callum Murray</h6>
    ...
    <div class="col-xxl-6">
        ...
        <div class="card">
            ...
            <div class="card-footer bg-transparent border-top">
                <!-- Nav tabs -->
                <ul class="nav nav-pills nav-justified card-footer-tabs fs-xl" role="tablist">
                    ...
                    <div class="col-lg-3">
                        <div class="nav nav-pills flex-column nav-pills-tab custom-verti-nav-pills text-center" role="tablist" aria-orientation="vertical">
                            <a class="nav-link active show" id="custom-v-pills-home-tab" data-bs-toggle="pill" href="#custom-v-pills-home" role="tab" aria-controls="custom-v-pills-home" aria-selected="true">
                                <i class="ri-home-4-line d-block fs-3xl mb-1"></i> Home
                            </a>
                            <a class="nav-link" id="custom-v-pills-profile-tab" data-bs-toggle="pill" href="#custom-v-pills-profile" role="tab" aria-controls="custom-v-pills-profile" aria-selected="false">
                                <i class="ri-user-2-line d-block fs-3xl mb-1"></i> Profile
                            </a>
                            <a class="nav-link" id="custom-v-pills-messages-tab" data-bs-toggle="pill" href="#custom-v-pills-messages" role="tab" aria-controls="custom-v-pills-messages" aria-selected="false">
                                <i class="ri-mail-line d-block fs-3xl mb-1"></i> Messages
                            </a>
                        </div>
                    </div> <!-- end col-->
                    <div class="col-lg-9">
                        <div class="tab-content text-muted mt-3 mt-lg-0">
                            ...
                            <div class="tab-pane fade" id="custom-v-pills-profile" role="tabpanel" aria-labelledby="custom-v-pills-profile-tab">
                                <div class="d-flex mb-4">
                                    <div class="flex-shrink-0">
                                        <img src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="" width="150" class="rounded">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                            ...
                            <div class="tab-pane fade" id="custom-v-pills-messages" role="tabpanel" aria-labelledby="custom-v-pills-messages-tab">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0">
                                        <img src="{{ URL::asset('build/images/small/img-8.jpg') }}" alt="" width="150" class="rounded">
                                    </div>
                                </div>
                            </div>
                            <!--end tab-pane-->
