                ...
                <table id="alternative-pagination" class="table nowrap dt-responsive align-middle table-hover table-bordered" style="width:100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>$888,411,910</td>
                            <td>
                                <h6 class="text-success fs-sm mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>1.50%</h6>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>$314,520,675</td>
                            <td>
                                <h6 class="text-danger fs-sm mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>0.42%</h6>
                            </td>
                            <td>
                                <button class="btn btn-sm btn-subtle-info">Trade Now</button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>$314,520,675</td>
                            <td>
                                <h6 class="text-success fs-sm mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>0.89%</h6>
                            </td>
                            <td>
                                <button class="btn btn-sm btn-subtle-info">Trade Now</button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>$9,847,327</td>
                            <td>
                                <h6 class="text-success fs-sm mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>1.92%</h6>
                            </td>
                            <td>
                                <button class="btn btn-sm btn-subtle-info">Trade Now</button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>$40,559,274</td>
                            <td>
                                <h6 class="text-danger fs-sm mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>2.87%</h6>
                            </td>
                            <td>
                                <button class="btn btn-sm btn-subtle-info">Trade Now</button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <h6 class="text-success fs-sm mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>3.96%</h6>
                            </td>
                            <td>
                                <button class="btn btn-sm btn-subtle-info">Trade Now</button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <h6 class="text-danger fs-sm mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>0.84%</h6>
                            </td>
                            <td>
                                <button class="btn btn-sm btn-subtle-info">Trade Now</button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>$156,209,195.18</td>
                            <td>
                                <h6 class="text-success fs-sm mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>8.20%</h6>
                            </td>
                            <td>
                                <button class="btn btn-sm btn-subtle-info">Trade Now</button>
                            </td>
