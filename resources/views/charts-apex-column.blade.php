    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="column_grouped_stacked_chart"
                        data-colors='["--tb-primary", "--tb-success","--tb-secondary", "--tb-warning"]' class="apex-charts"
                        dir="ltr"></div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="column_dumbbell_chart" data-colors='["--tb-primary", "--tb-success"]' class="apex-charts"
                        dir="ltr"></div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div><!-- end col -->
