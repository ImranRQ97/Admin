                                ...
                                <td class="customer">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2">
                                            <div>
                                                <img class="avatar-xs rounded-circle customer-image-elem" alt="" src="{{ URL::asset('build/images/users/32/avatar-2.jpg') }}">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
            ...
            <div class="card-body">
                <div class="d-flex gap-3 align-items-center flex-wrap">
                    <div class="flex-shirnk-0">
                        <img src="{{ URL::asset('build/images/users/48/avatar-5.jpg') }}" alt="" class="avatar-sm rounded overview-img">
                    </div>
                    <div class="flex-grow-1">
                    ...
                    <div class="vstack gap-2">
                        ...
                        <div class="p-2 border border-dashed">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm flex-shrink-0">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="{{ URL::asset('build/images/products/32/img-2.png') }}" alt="" class="avatar-xs">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#!">
                        ...
                        <div class="p-2 border border-dashed">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm flex-shrink-0">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="{{ URL::asset('build/images/products/32/img-4.png') }}" alt="" class="avatar-xs">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#!">
                        ...
                        <div class="p-2 border border-dashed">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm flex-shrink-0">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="{{ URL::asset('build/images/products/32/img-5.png') }}" alt="" class="avatar-xs">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#!">
                        ...
                        <div class="position-relative d-inline-block">
                            ...
                            <div class="avatar-lg">
                                <div class="avatar-title bg-light rounded-3">
                                    <img src="{{ URL::asset('build/images/users/user-dummy-img.jpg') }}" alt="" id="customer-img" class="avatar-md h-auto rounded-3 object-fit-cover">
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- ecommerce-customer -->
<script src="{{ URL::asset('build/js/pages/ecommerce-customer.init.js') }}"></script>
