                    ...
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <div class="d-flex flex-column h-100">
                                ...
                                <h3 class="mb-0 mt-auto"><span class="counter-value" data-target="149.36">0</span>k <small
                                        class="text-success fs-xs mb-0 ms-1"><i class="bi bi-arrow-up me-1"></i>
                                        12.33%</small></h3>
                            </div>
                        </div>
                    ...
                    <div class="flex-shrink-0">
                        <div class="dropdown card-header-dropdown sortble-dropdown">
                            <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown"
                                ...
                                </span><span class="text-muted dropdown-title">Property Name</span> <i
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody class="list">
                                <tr>
                                    <td class="propert_id">
                                        <a href="apps-ecommerce-order-overview" class="fw-medium link-primary">#TBS01</a>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2 position-relative">
                                            <img src="{{ URL::asset('build/images/real-estate/img-01.jpg') }}" alt="" height="35"
                                                class="rounded">
                                            <a href="apps-real-estate-property-overview"
                                                class="propert_name text-reset stretched-link">The Country House</a>
                                        </div>
                                    </td>
                                    <td class="address">
                                        United Kingdom
                                ...
                                <tr>
                                    <td class="propert_id">
                                        <a href="apps-ecommerce-order-overview" class="fw-medium link-primary">#TBS02</a>
                                    </td>
                                    <td class="propert_type">
                                        Residency
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2 position-relative">
                                            <img src="{{ URL::asset('build/images/real-estate/img-02.jpg') }}" alt="" height="35"
                                                class="rounded">
                                            <a href="apps-real-estate-property-overview"
                                                class="propert_name text-reset stretched-link">Classic White House</a>
                                        </div>
                                    </td>
                                    <td class="address">
                                        Germany
                                    ...
                                    <td class="price">
                                        <span class="fw-medium">$2451.20</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="propert_id">
                                        <a href="apps-ecommerce-order-overview" class="fw-medium link-primary">#TBS03</a>
                                    </td>
                                    <td class="propert_type">
                                        Apartment
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2 position-relative">
                                            <img src="{{ URL::asset('build/images/real-estate/img-03.jpg') }}" alt="" height="35"
                                                class="rounded">
                                            <a href="apps-real-estate-property-overview"
                                                class="propert_name text-reset stretched-link">Vintage Apartment</a>
                                        </div>
                                    </td>
                                    <td class="address">
                                        Brazil
                                ...
                                <tr>
                                    <td class="propert_id">
                                        <a href="apps-ecommerce-order-overview" class="fw-medium link-primary">#TBS04</a>
                                    </td>
                                    <td class="propert_type">
                                        Villa
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2 position-relative">
                                            <img src="{{ URL::asset('build/images/real-estate/img-04.jpg') }}" alt="" height="35"
                                                class="rounded">
                                            <a href="apps-real-estate-property-overview"
                                                class="propert_name text-reset stretched-link">Whitespace Vintage Villa</a>
                                        </div>
                                    </td>
                                    <td class="address">
                                        Spain
                                    ...
                                    <td class="price">
                                        <span class="fw-medium">$3495.76</span>
                                    </td>
                                    <td>
                                        <span class="badge bg-danger-subtle text-danger status">Sale</span>
                                    </td>
                                ...
                                <tr>
                                    <td class="propert_id">
                                        <a href="apps-ecommerce-order-overview" class="fw-medium link-primary">#TBS05</a>
                                    </td>
                                    <td class="propert_type">
                                        Residency
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2 position-relative">
                                            <img src="{{ URL::asset('build/images/real-estate/img-05.jpg') }}" alt="" height="35"
                                                class="rounded">
                                            <a href="apps-real-estate-property-overview"
                                                class="propert_name text-reset stretched-link">Duplex Square Valley</a>
                                        </div>
                                    </td>
                                    <td class="address">
                                        Mexico
                                    ...
                                    <td class="price">
                                        <span class="fw-medium">$2579.31</span>
                                    </td>
                                    <td>
                                        <span class="badge bg-info-subtle text-info status">Rent</span>
                                    </td>
                                ...
                                <tr>
                                    <td class="propert_id">
                                        <a href="apps-ecommerce-order-overview" class="fw-medium link-primary">#TBS06</a>
                                    </td>
                                    <td class="propert_type">
                                        Residency
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2 position-relative">
                                            <img src="{{ URL::asset('build/images/real-estate/img-06.jpg') }}" alt="" height="35"
                                                class="rounded">
                                            <a href="apps-real-estate-property-overview"
                                                class="propert_name text-reset stretched-link">Small Grey Brick Home In A
                                                Subdivision</a>
                                        </div>
                                    </td>
                                    <td class="address">
                                    ...
                                    <td class="agent_name">Josefa Weissnat</td>
                                    <td class="price">
                                        <span class="fw-medium">$1478.00</span>
                                    </td>
                                    <td>
                                        <span class="badge bg-danger-subtle text-danger status">Sale</span>
                                    </td>
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <a href="#!" class="text-muted">View All <i
                    ...
                    <div data-simplebar style="max-height: 400px;">
                            ...
                            <div class="card-body pt-0">
                                <div class="d-flex gap-2">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <h6 class="fs-md mb-1"><a href="#!" class="text-reset">Josefa Weissnat</a>
                                        </h6>
                                        ...
                                        <p class="text-muted mb-0">" Themebrand used AnyDesk to fix the bug in Flask and
                                            django version. I highly recommend this product! "</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card border-bottom rounded-0 border-0 shadow-none mb-0">
                            <div class="card-body">
                                <div class="d-flex gap-2">
                                    <div class="flex-shrink-0">
                                        <img src="{{ URL::asset('build/images/users/48/avatar-3.jpg') }}" alt=""
                                            class="avatar-sm rounded">
                                    </div>
                                    <div class="flex-grow-1">
                                        <span class="text-muted clearfix float-end">11:24 AM</span>
                                        <h6 class="fs-md mb-1"><a href="#!" class="text-reset">Ophelia Steuber</a>
                                        </h6>
                                        <div class="text-warning mb-2 fs-xs">
                                            <i class="bi bi-star-fill"></i>
                                            <i class="bi bi-star-fill"></i>
                                        ...
                                        <p class="text-muted mb-0">" Thank you for this awesome admin panel. I'm very happy
                                            with it, it's a pleasure to work with it! "</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex gap-2">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted mb-0">" High theme quality. Very good support, they spent
                                            almost an hour remotely to fix a problem. I hope this theme will have a long
                                            term support. "</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex gap-2">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted mb-0">" There is as lot packed in this template. The savings
                                            in time and energy is so worth it. "</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex gap-2">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted mb-0">" Works like a component library, a crazy amount of
                                            design elements already built and given. "</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-xxl-4 col-lg-6">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <div class="nav nav-pills gap-1" id="popularProperty" role="tablist"
                            aria-orientation="vertical">
                            <button class="btn btn-ghost-danger btn-sm active" id="saleProperty" data-bs-toggle="pill"
                                data-bs-target="#salePropertyTabs" type="button" role="tab"
                                aria-controls="salePropertyTabs" aria-selected="true">Sale</button>
                            <button class="btn btn-ghost-info btn-sm" id="rentProperty" data-bs-toggle="pill"
                                data-bs-target="#rentPropertyTabs" type="button" role="tab"
                                aria-controls="rentPropertyTabs" aria-selected="false" tabindex="-1">Rent</button>
                        </div>
                    </div>
                </div>
                <!--end header-->
                <div class="card-body">
                    <div class="tab-content mb-2" id="popularPropertyContent">
                        <div class="tab-pane show active" id="salePropertyTabs" role="tabpanel"
                            aria-labelledby="saleProperty" tabindex="0">
                            <div class="d-flex gap-2 align-items-center position-relative mb-3">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/real-estate/img-08.jpg') }}" alt="" height="44"
                                    ...
                                    <ul class="d-flex align-items-center gap-2 flex-wrap list-unstyled mb-0">
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-house align-baseline text-primary me-1"></i> 2 Bedroom</p>
                                        </li>
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="ph ph-bathtub align-middle text-primary me-1"></i> 1 Bathroom
                                            </p>
                                        </li>
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-columns align-baseline text-primary me-1"></i> 1039 sqft
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="flex-shrink-0">
                                    <span class="badge bg-warning-subtle text-warning"><i
                                            class="bi bi-star-fill text-warning"></i> 4.5</span>
                                </div>
                            </div>
                            <div class="d-flex gap-2 align-items-center position-relative mb-3">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/real-estate/img-07.jpg') }}" alt="" height="44"
                                        class="object-fit-cover rounded">
                                </div>
                                <div class="flex-grow-1">
                                    <a href="apps-real-estate-property-overview" class="stretched-link">
                                    ...
                                    <ul class="d-flex align-items-center gap-2 flex-wrap list-unstyled mb-0">
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-house align-baseline text-primary me-1"></i> 4 Bedroom</p>
                                        </li>
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="ph ph-bathtub align-middle text-primary me-1"></i> 2 Bathroom
                                            </p>
                                        </li>
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-columns align-baseline text-primary me-1"></i> 1145 sqft
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="flex-shrink-0">
                                    <span class="badge bg-warning-subtle text-warning"><i
                                            class="bi bi-star-fill text-warning"></i> 4.9</span>
                                </div>
                            </div>
                            <div class="d-flex gap-2 align-items-center position-relative mb-3">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/real-estate/img-05.jpg') }}" alt="" height="44"
                                        class="object-fit-cover rounded">
                                </div>
                                <div class="flex-grow-1">
                                    <a href="apps-real-estate-property-overview" class="stretched-link">
                                    ...
                                    <ul class="d-flex align-items-center gap-2 flex-wrap list-unstyled mb-0">
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-house align-baseline text-primary me-1"></i> 3 Bedroom</p>
                                        </li>
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="ph ph-bathtub align-middle text-primary me-1"></i> 3 Bathroom
                                            </p>
                                        </li>
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-columns align-baseline text-primary me-1"></i> 1859 sqft
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="flex-shrink-0">
                                    <span class="badge bg-warning-subtle text-warning"><i
                                            class="bi bi-star-fill text-warning"></i> 4.7</span>
                                </div>
                            </div>
                            <div class="d-flex gap-2 align-items-center position-relative mb-3">
                                <div class="flex-shrink-0">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <ul class="d-flex align-items-center gap-2 flex-wrap list-unstyled mb-0">
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-house align-baseline text-primary me-1"></i> 5 Bedroom</p>
                                        </li>
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="ph ph-bathtub align-middle text-primary me-1"></i> 3 Bathroom
                                        ...
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-columns align-baseline text-primary me-1"></i> 5643 sqft
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="d-flex gap-2 align-items-center position-relative mb-3">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/real-estate/img-04.jpg') }}" alt="" height="44"
                                        class="object-fit-cover rounded">
                                </div>
                                <div class="flex-grow-1">
                                    <a href="apps-real-estate-property-overview" class="stretched-link">
                                    ...
                                    <ul class="d-flex align-items-center gap-2 flex-wrap list-unstyled mb-0">
                                        ...
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-columns align-baseline text-primary me-1"></i> 1963 sqft
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="flex-shrink-0">
                                    <span class="badge bg-warning-subtle text-warning"><i
                                            class="bi bi-star-fill text-warning"></i> 4.8</span>
                                </div>
                            </div>
                            <div class="d-flex gap-2 align-items-center position-relative mb-3">
                                <div class="flex-shrink-0">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <ul class="d-flex align-items-center gap-2 flex-wrap list-unstyled mb-0">
                                        ...
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-columns align-baseline text-primary me-1"></i> 1543 sqft
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="flex-shrink-0">
                                    <span class="badge bg-warning-subtle text-warning"><i
                                            class="bi bi-star-fill text-warning"></i> 4.4</span>
                                </div>
                            </div>
                            <div class="d-flex gap-2 align-items-center position-relative">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/real-estate/img-03.jpg') }}" alt="" height="44"
                                        class="object-fit-cover rounded">
                                </div>
                                <div class="flex-grow-1">
                                    <a href="apps-real-estate-property-overview" class="stretched-link">
                                    ...
                                    <ul class="d-flex align-items-center gap-2 flex-wrap list-unstyled mb-0">
                                        ...
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-columns align-baseline text-primary me-1"></i> 3652 sqft
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="tab-pane" id="rentPropertyTabs" role="tabpanel" aria-labelledby="rentProperty"
                            tabindex="0">
                            <div class="d-flex gap-2 align-items-center position-relative mb-3">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/real-estate/img-01.jpg') }}" alt="" height="44"
                                        class="object-fit-cover rounded">
                                </div>
                                <div class="flex-grow-1">
                                    <a href="apps-real-estate-property-overview" class="stretched-link">
                                    ...
                                    <ul class="d-flex align-items-center gap-2 flex-wrap list-unstyled mb-0">
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-house align-baseline text-primary me-1"></i> 1 Bedroom</p>
                                        </li>
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="ph ph-bathtub align-middle text-primary me-1"></i> 1 Bathroom
                                        ...
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-columns align-baseline text-primary me-1"></i> 958 sqft
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="flex-shrink-0">
                                    <span class="badge bg-warning-subtle text-warning"><i
                                            class="bi bi-star-fill text-warning"></i> 4.3</span>
                                </div>
                            </div>
                            <div class="d-flex gap-2 align-items-center position-relative mb-3">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/real-estate/img-02.jpg') }}" alt="" height="44"
                                        class="object-fit-cover rounded">
                                </div>
                                <div class="flex-grow-1">
                                    <a href="apps-real-estate-property-overview" class="stretched-link">
                                    ...
                                    <ul class="d-flex align-items-center gap-2 flex-wrap list-unstyled mb-0">
                                        ...
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-columns align-baseline text-primary me-1"></i> 2659 sqft
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="flex-shrink-0">
                                    <span class="badge bg-warning-subtle text-warning"><i
                                            class="bi bi-star-fill text-warning"></i> 3.8</span>
                                </div>
                            </div>
                            <div class="d-flex gap-2 align-items-center position-relative mb-3">
                                <div class="flex-shrink-0">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <ul class="d-flex align-items-center gap-2 flex-wrap list-unstyled mb-0">
                                        ...
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-columns align-baseline text-primary me-1"></i> 2230 sqft
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="d-flex gap-2 align-items-center position-relative mb-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <ul class="d-flex align-items-center gap-2 flex-wrap list-unstyled mb-0">
                                        ...
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-columns align-baseline text-primary me-1"></i> 2785 sqft
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="d-flex gap-2 align-items-center position-relative">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <ul class="d-flex align-items-center gap-2 flex-wrap list-unstyled mb-0">
                                        ...
                                        <li>
                                            <p class="text-muted mb-0"><i
                                                    class="bi bi-columns align-baseline text-primary me-1"></i> 1324 sqft
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="text-center">
                        <a href="apps-real-estate-list" class="icon-link">View All <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
                <!--end card-->
            </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-xxl-3 col-md-6 border-end-md border-dashed">
                                        <div class="text-center">
                                            ...
                                            <div class="mx-3 mb-3 pb-1">
                                                <div id="mini-chart-6" data-colors='["--tb-secondary"]'
                                                    class="apex-charts" dir="ltr"></div>
                                            </div>
                                            <h5 class="mb-0">2451 <small
                                                    class="badge fs-2xs bg-danger-subtle text-danger ms-1"><i
                                                        class="ph-arrow-down align-baseline"></i> 1.02%</small></h5>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-xxl-3 col-md-6 border-end-xxl border-dashed">
                                        <div class="text-center">
                                            ...
                                            <div class="mx-3 mb-3 pb-1">
                                                <div id="mini-chart-7" data-colors='["--tb-primary"]' class="apex-charts"
                                                    dir="ltr"></div>
                                            </div>
                                            <h5 class="mb-0">$750.36M <small
                                                    class="badge fs-2xs bg-success-subtle text-success ms-1"><i
                                                        class="ph-arrow-up align-baseline"></i> 2.17%</small></h5>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-xxl-3 col-md-6 border-end-md border-dashed">
                                        <div class="text-center">
                                            ...
                                            <div class="mx-3 mb-3 pb-1">
                                                <div id="mini-chart-8" data-colors='["--tb-warning"]' class="apex-charts"
                                                    dir="ltr"></div>
                                            </div>
                                            <h5 class="mb-0">$750.36M <small
                                                    class="badge fs-2xs bg-success-subtle text-success ms-1"><i
                                                        class="ph-arrow-up align-baseline"></i> 07.26%</small></h5>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-xxl-3 col-md-6">
                                        <div class="text-center">
                                            ...
                                            <div class="mx-3 mb-3 pb-1">
                                                <div id="mini-chart-9" data-colors='["--tb-success"]' class="apex-charts"
                                                    dir="ltr"></div>
                                            </div>
                                            <h5 class="mb-0">4689 <small
                                                    class="badge fs-2xs bg-success-subtle text-success ms-1"><i
                                                        class="ph-arrow-up align-baseline"></i> 3.62%</small></h5>
                                        </div>
                                    </div>
                                    <!--end col-->
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0">
                                    <a href="pages-timeline" class="text-muted">View All <i
                                            class="bi bi-chevron-right align-baseline"></i></a>
                                </div>
                            </div>
                            <div class="card-body px-0">
                                <div class="px-3" data-simplebar style="height: 255px">
                                    <div class="acitivity-timeline acitivity-main">
                                        ...
                                        <div class="acitivity-item py-3 d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('build/images/users/32/avatar-1.jpg') }}" alt=""
                                                    class="avatar-xs rounded-circle acitivity-avatar">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="mb-1 lh-base">Natasha Carey have liked the products</h6>
                                                <p class="text-muted mb-2">Allow users to like products in your WooCommerce
                                                    store.</p>
                                        ...
                                        <div class="acitivity-item py-3 d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('build/images/users/32/avatar-3.jpg') }}" alt=""
                                                    class="avatar-xs rounded-circle acitivity-avatar">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="text-muted mb-2">Offer is valid on orders of $230 Or above for
                                        ...
                                        <div class="acitivity-item d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('build/images/users/32/avatar-5.jpg') }}" alt=""
                                                    class="avatar-xs rounded-circle acitivity-avatar">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0">
                                    <a href="apps-real-estate-agent-list" class="text-muted">View All <i
                                            class="bi bi-chevron-right align-baseline"></i></a>
                                </div>
                            </div>
