            ...
            <div class="col-xxl-4 col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <button type="button" class="btn-close float-end fs-xxs" aria-label="Close"></button>
                    ...
                    <div class="card-body">
                        <blockquote class="card-blockquote mb-0">
                            ...
                            <figure class="mb-0">
                                ...
                                <figcaption class="blockquote-footer fs-sm text-end mb-0">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <ul class="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                            ...
                            <li class="list-inline-item">
                                <button type="button" onclick="delthis('card-none1')" class="btn-close fs-3xs align-middle"></button>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <ul class="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                            ...
                            <li class="list-inline-item">
                                <button type="button" onclick="delthis('card-none2')" class="btn-close fs-3xs align-middle"></button>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <ul class="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                            ...
                            <li class="list-inline-item">
                                <button type="button" onclick="delthis('card-none3')" class="btn-close fs-3xs align-middle"></button>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xxl-4 col-lg-6">
                <div class="card card-overlay">
                    <img class="card-img img-fluid" src="{{ URL::asset('build/images/small/img-12.jpg') }}" alt="Card image">
            ...
            <div class="col-xxl-4 col-lg-6">
                <div class="card card-overlay">
                    <img class="card-img img-fluid" src="{{ URL::asset('build/images/small/img-1.jpg') }}" alt="Card image">
            ...
            <div class="col-xxl-4 col-lg-6">
                <div class="card card-overlay">
                    <img class="card-img img-fluid" src="{{ URL::asset('build/images/small/img-5.jpg') }}" alt="Card image">
        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-lg-6">
                <div class="card">
                    ...
                    <img class="card-img rounded-0 img-fluid" src="{{ URL::asset('build/images/small/img-8.jpg') }}" alt="Card image cap">
                    <div class="card-footer">
            ...
            <div class="col-xxl-4 col-lg-6">
                <div class="card">
                    ...
                    <img class="card-img rounded-0 img-fluid" src="{{ URL::asset('build/images/small/img-10.jpg') }}" alt="Card image cap">
                    <div class="card-footer">
                        <p class="card-text mb-0">
                            Last updated 3 mins ago
                        </p>
            ...
            <div class="col-xxl-4 col-lg-6">
                <div class="card">
                    <img class="card-img-top img-fluid" src="{{ URL::asset('build/images/small/img-11.jpg') }}" alt="Card image cap">
                    <div class="card-header">
                        <h4 class="card-title mb-0">A day in the of a professional fashion designer</h4>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xxl-4 col-lg-6">
                <div class="card">
                    ...
                    <img class="card-img-bottom img-fluid" src="{{ URL::asset('build/images/small/img-11.jpg') }}" alt="Card image cap">
                </div>
            </div><!-- end col -->
        </div>
        ...
        <div class="row">
            <div class="col-xxl-6">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img class="rounded-start img-fluid h-100 object-cover" src="{{ URL::asset('build/images/small/img-12.jpg') }}" alt="Card image">
                        </div>
                        <div class="col-md-8">
                            <div class="card-header">
            ...
            <div class="col-xxl-6">
                <div class="card">
                    <div class="row g-0">
                        ...
                        <div class="col-md-4">
                            <img class="rounded-end img-fluid h-100 object-cover" src="{{ URL::asset('build/images/small/img-4.jpg') }}" alt="Card image">
                        </div>
                    </div>
                </div><!-- end card -->
            </div><!-- end col -->
            ...
            <div class="col-xxl-6">
                <div class="card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img class="rounded-start img-fluid h-100 object-cover" src="{{ URL::asset('build/images/small/img-9.jpg') }}" alt="Card image">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-xxl-6">
                <div class="card">
                    <div class="row g-0">
                        ...
                        <div class="col-md-4">
                            <img class="rounded-end img-fluid h-100 object-cover" src="{{ URL::asset('build/images/small/img-2.jpg') }}" alt="Card image">
                        </div>
                    </div>
                </div><!-- end card -->
            </div><!-- end col -->
...
<div class="row">
    <div class="col-12">
        ...
        <div class="row">
            <div class="col-xxl-4">
                <div class="card border overflow-hidden card-border-primary">
                    <div class="card-header">
                        <span class="float-end">75%</span>
                        <h6 class="card-title mb-0">Handle to Forcast <span class="badge bg-danger align-middle fs-3xs">Poor</span></h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xxl-4">
                <div class="card border overflow-hidden card-border-success">
                    <div class="card-header">
                        <span class="float-end">100%</span>
                        <h6 class="card-title mb-0">Quality Forcast <span class="badge bg-success align-middle fs-3xs">Excellent</span></h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xxl-4">
                <div class="card border overflow-hidden card-border-info">
                    <div class="card-header">
                        <h6 class="card-title mb-0">Check your E-mails <span class="badge bg-info align-middle fs-3xs">In Process</span></h6>
                    </div>
                    <div class="card-body">
                        <p class="card-text">They all have something to say beyond the words on the page. They can come across as casual or neutral, exotic or graphic. Cosby sweater eu banh mi, qui irure terry richardson ex squid.</p>
                        <div class="text-end">
...
<div class="row">
    <div class="col-xxl-4">
        <div class="card border overflow-hidden card-border-warning">
            <div class="card-header">
                <h6 class="card-title mb-0">Check your Payment <span class="badge bg-warning align-middle fs-3xs">Pending</span></h6>
            </div>
            <div class="card-body">
                <p class="card-text">They all have something to say beyond the words on the page. They can come across as casual or neutral, exotic or graphic. Cosby sweater eu banh mi, qui irure terry richardson ex squid.</p>
                <div class="text-end">
    ...
    <div class="col-xxl-4">
        <div class="card border overflow-hidden card-border-danger">
            <div class="card-header">
                <h6 class="card-title mb-0">Your Ordered Cancel <span class="badge bg-danger align-middle fs-3xs">Cancel</span></h6>
            </div>
            <div class="card-body">
                <p class="card-text">They all have something to say beyond the words on the page. They can come across as casual or neutral, exotic or graphic. Cosby sweater eu banh mi, qui irure terry richardson ex squid.</p>
                <div class="text-end">
    ...
    <div class="col-xxl-4">
        <div class="card border overflow-hidden card-border-dark">
            <div class="card-header">
...
<div class="row">
    <div class="col-xxl-4">
        <div class="card border overflow-hidden card-border-secondary">
            <div class="card-header">
...
<div class="row g-3">
    ...
    <div class="col-xxl col-md-4">
        <div class="card h-100">
            ...
            <img class="img-fluid" src="{{ URL::asset('build/images/small/img-11.jpg') }}" alt="Card image cap">
            <div class="card-body">
    ...
    <div class="col-xxl col-md-4">
        <div class="card h-100">
            <img class="card-img-top img-fluid" src="{{ URL::asset('build/images/small/img-10.jpg') }}" alt="Card image cap">
            <div class="card-body">
                <h4 class="card-title">Give your text a good structure?</h4>
                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
            </div>
        ...
        <div class="row" data-masonry='{"percentPosition": true }'>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="card">
                    <div class="card-header">
                        <button type="button" class="btn-close float-end fs-xxs" aria-label="Close"></button>
                        <h6 class="fs-base mb-0">Hi, Erica Kernan</h6>
                    </div>
                    <div class="card-body">
                        <h6 class="card-title">How to get creative in your work ?</h6>
                        <p class="card-text text-muted mb-0">A business consulting agency is involved in the planning, implementation, and education of businesses. Miss told ham dull knew see she spot near can. Spirit her entire her called.</p>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex position-relative">
                            <img src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" class="flex-shrink-0 me-3 avatar-xl rounded" alt="...">
                            <div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row g-0 bg-light position-relative">
                            <div class="col-md-5">
                                <img src="{{ URL::asset('build/images/small/img-4.jpg') }}" class="rounded-start img-fluid" alt="...">
                            </div>
