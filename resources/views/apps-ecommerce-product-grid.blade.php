...
@section('title') @lang('translation.product-grid') @endsection
...
@slot('title') Products Grid @endslot
@endcomponent
    ...
    <div class="col-xxl-9">
        <div class="row align-items-center mb-4 g-3">
            ...
            <div class="col-lg-auto">
                <a href="apps-ecommerce-add-product" class="btn btn-primary"><i class="bi bi-plus-circle align-baseline me-1"></i> Add Product</a>
            </div>
            <!--end col-->
        </div>
        <!--end row-->
