...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="index" class="logo logo-light">
            <span class="logo-sm">
                <img src="{{ asset('build/images/fin-logo.jpg') }}" alt="Fin Logo" height="22">
            </span>
            <span class="logo-lg">
                <img src="{{ URL::asset('build/images/fin-logo.jpg') }}" alt="" height="60">
            </span>
        </a>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="index" class="nav-link" data-key="t-transaction">
                        <i class="ph-gauge">
                        </i> <span>@lang('Dashboard')</span></a>
                </li>
                <!-- <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#sidebarTransactions" data-bs-toggle="collapse"
                        role="button" aria-expanded="false" aria-controls="sidebarTransactions">
                        <i class="ph-list"></i>

                        </i> <span>@lang('Transactions')</span>
                    </a>
                </li> -->
                ...
                <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                        ...
                        <a href="dashboard-transaction" class="nav-link" data-key="t-transaction">
                            @lang('translation.transactions') </a>
                    </li>
                    <!-- <li class="nav-item">
                        <a href="apps-ecommerce-add-product" class="nav-link"
                            data-key="t-create-fullform">@lang('Fill-Form')</a>
                    </li>
                    <li class="nav-item">
                        <a href="apps-ecommerce-fullform-product" class="nav-link"
                            data-key="t-create-product">@lang('Full-Form')</a>
                    </li> -->

                    <!-- <li class="nav-item">
                            <a href="apps-ecommerce-extract-overview" class="nav-link"
                                data-key="t-order-extract">@lang('Verification')</a>
                        </li>
                        <li class="nav-item">
                            <a href="apps-ecommerce-generate-lr" class="nav-link"
                                data-key="t-order-generate_lr">@lang('Generate-Lr')</a>
                        </li>

                        <li class="nav-item">
                            <a href="apps-ecommerce-customers" class="nav-link"
                                data-key="t-customers">@lang('upload-acknowledgement')</a>
                        </li> -->
                    <!-- <li class="nav-item">
                                <a href="dashboard-analytics" class="nav-link" data-key="t-analytics">
                                    @lang('translation.analytics') </a>
                    ...
                    <!-- <li class="nav-item">
                                ...
                                <a href="dashboard-crm" class="nav-link" data-key="t-crm">
        ...
        <!-- <a href="#sidebarEcommerce" class="nav-link menu-link collapsed" data-bs-toggle="collapse"
                        ...
                        <i class="ph-storefront"></i> <span data-key="t-ecommerce">@lang('Form')</span>
                    </a>
        ...
        <!-- <li class="nav-item">
                                <a href="apps-ecommerce-generate-lr-pdf" class="nav-link"
                                    data-key="t-shopping-cart">@lang('Generate-Lr-Pdf')</a>
                            </li> -->
        <!-- <li class="nav-item">
        ...
        <!-- <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="apps-ecommerce-seller-overview" class="nav-link"
                                    data-key="t-seller-overview">@lang('Verification')</a>
                            </li> -->
        </ul>
    </div>
    <!-- </li> -->
    ...
    <!-- <li class="nav-item">
                    <a href="#sidebarLearning" class="nav-link menu-link  collapsed" data-bs-toggle="collapse"
                        ...
                        <i class="ph-graduation-cap"></i> <span
                            data-key="t-learning">@lang('translation.learning')</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarLearning">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="#sidebarInstructors" class="nav-link" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarInstructors" data-key="t-instructors">
                                    @lang('translation.instructors')</a>
                ...
                <li class="nav-item">
                    <a href="#sidebarTickets" class="nav-link menu-link collapsed" data-bs-toggle="collapse"
                        ...
                        <i class="ph-ticket"></i> <span
                            data-key="t-support-tickets">@lang('translation.supprt-tickets')</span>
                    </a>
                ...
                <li class="nav-item">
                    <a href="#sidebarRealeEstate" class="nav-link menu-link collapsed" data-bs-toggle="collapse"
                        ...
                        <i class="ph-buildings"></i> <span
                            data-key="t-real-estate">@lang('translation.realestate')</span>
                    </a>
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="#sidebarAgent" class="nav-link" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarAgent" data-key="t-agent">
                                    @lang('translation.agent') </a>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarAgencies" class="nav-link" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="sidebarAgencies"
    ...
    <!-- <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#sidebarAuth" data-bs-toggle="collapse" role="button"
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#sidebarPages" data-bs-toggle="collapse" role="button"
                        ...
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="pages-starter" class="nav-link"
                                    data-key="t-starter">@lang('translation.starter')
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="pages-profile" class="nav-link" data-key="t-profile">
                            ...
                            <li class="nav-item">
                                <a href="pages-pricing" class="nav-link" data-key="t-pricing">
    ...
    <!-- <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#sidebarUI" data-bs-toggle="collapse" role="button"
    ...
    <!-- <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#sidebarAdvanceUI" data-bs-toggle="collapse"
                        ...
                        <i class="ph-stack-simple"></i> <span
                            data-key="t-advance-ui">@lang('translation.advance-ui')</span>
                    </a>
    ...
    <!-- <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#customUI" data-bs-toggle="collapse" role="button"
                        aria-expanded="false" aria-controls="customUI">
                        <i class="ph-wrench"></i> <span data-key="t-custom-ui">@lang('translation.custom-ui')</span>
                        <span class="badge badge-pill bg-danger" data-key="t-custom">@lang('translation.custom')</span>
                    </a>
    ...
    <!-- <li class="nav-item">
                    <a class="nav-link menu-link" href="widgets">
                        <i class="ph-paint-brush-broad"></i> <span
                            data-key="t-widgets">@lang('translation.widgets')</span>
                    </a>
                </li> -->
    <!-- 
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#sidebarForms" data-bs-toggle="collapse" role="button"
