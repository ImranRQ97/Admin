                                ...
                                <div class="row align-items-center gy-3">
                                    <div class="col-lg-3 col-md-6 order-last order-md-first me-auto">
                                        <div class="search-box">
                                            <input type="text" class="form-control search" placeholder="Search for property, price or something...">
                                    ...
                                    <div class="col-md-auto col-6 text-end">
                                        <div class="d-flex flex-wrap align-items-start gap-2">
                                            ...
                                            <button class="btn btn-secondary add-btn" data-bs-toggle="modal" data-bs-target="#addProperty"><i class="bi bi-house align-baseline me-1"></i> Add Property</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                        ...
                                        <tbody class="list form-check-all">
                                            <tr>
                                                ...
                                                <td class="id"><a href="apps-real-estate-property-overview" class="fw-medium link-primary">#TBS01</a></td>
                                                <td class="propert_Name text-capitalize"><a href="apps-real-estate-property-overview" class="text-reset">The Country House</a></td>
                                                <td class="address">United Kingdom</td>
                                                <td class="bedroom">2 Bedroom</td>
                                                <td class="bathroom d-none">2 Bedroom</td>
                                                <td class="propert_type">Villa</td>
                                                <td class="sqft">1458</td>
                                                <td class="agents">Josefa Weissnat</td>
                                                <td class="amount"><span class="fw-medium">$2451.39</span></td>
                                                <td class="status"><span class="badge bg-danger-subtle text-danger">Sale</span></td>
                                                <td>    
                                                    <ul class="d-flex gap-2 list-unstyled mb-0">
                                                        <li>
                                                            <a href="apps-real-estate-property-overview" class="btn btn-subtle-primary btn-icon btn-sm "><i class="ph-eye"></i></a>
                                                        </li>
                                                        <li>
                                                            <a href="#addProperty" data-bs-toggle="modal" class="btn btn-subtle-secondary btn-icon btn-sm edit-item-btn"><i class="ph-pencil"></i></a>
                                                        </li>
                                                        <li>
                                    ...
                                    <div class="noresult" style="display: none">
                                        <div class="text-center py-4">
                                            ...
                                            <p class="text-muted mb-0">We've searched more than 150+ property We did not find any property for you search.</p>
                                        </div>
                                    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-addPropertyModal"></button>
                    </div>
                    ...
                    <form class="tablelist-form" novalidate autocomplete="off">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="property-type-input">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="agent-name-input" placeholder="Enter Agent Name " required >
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="requirement-input">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="addressLine-input" rows="3" placeholder="Enter sort address" required></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script src="{{ URL::asset('build/js/pages/real-estate-list.init.js') }}"></script>
