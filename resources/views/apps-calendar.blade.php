                    ...
                    <div class="px-3 mx-n3 mb-3" data-simplebar style="height: 400px">
                        <div class="acitivity-timeline acitivity-main">
                            ...
                            <div class="acitivity-item py-3 d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-1 lh-base">Today offers by <a href="apps-ecommerce-seller-details" class="link-secondary">Digitate Galaxy</a></h6>
                            ...
                            <div class="acitivity-item d-flex">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                </div>
                                <div class="flex-grow-1 ms-3">
                ...
                <div class="card bg-primary">
                    <div class="card-body ">
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('build/images/calendar.png') }}" alt="" class="avatar-lg">
                            </div>
                        </div>
                    </div>
                </div>
