                    ...
                    <div data-simplebar style="height: 242px;" class="mx-n3">
                        <ul class="list list-group list-group-flush mb-0">
                            <li class="list-group-item" data-id="1">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h5 class="fs-base mb-1"><a href="#" class="link name text-reset">Jonny Stromberg</a></h5>
                                        <p class="born timestamp text-muted mb-0" data-timestamp="12345">1986</p>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <div>
                                            <img class="image avatar-xs rounded-circle" alt="" src="{{ URL::asset('build/images/users/avatar-1.jpg') }}">
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item" data-id="2">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h5 class="fs-base mb-1"><a href="#" class="link name text-reset">Jonas Arnklint</a></h5>
                                        <p class="born timestamp text-muted mb-0" data-timestamp="23456">1985</p>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <div>
                                            <img class="image avatar-xs rounded-circle" alt="" src="{{ URL::asset('build/images/users/avatar-2.jpg') }}">
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item" data-id="3">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h5 class="fs-base mb-1"><a href="#" class="link name text-reset">Martina Elm</a></h5>
                                        <p class="born timestamp text-muted mb-0" data-timestamp="34567">1986</p>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <div>
                                            <img class="image avatar-xs rounded-circle" alt="" src="{{ URL::asset('build/images/users/avatar-3.jpg') }}">
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item" data-id="4">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h5 class="fs-base mb-1"><a href="#" class="link name text-reset">Gustaf Lindqvist</a></h5>
                                        <p class="born timestamp text-muted mb-0" data-timestamp="45678">1983</p>
                                    </div>
                                    <div class="flex-shrink-0">
                                        <div>
                                            <img class="image avatar-xs rounded-circle" alt="" src="{{ URL::asset('build/images/users/avatar-4.jpg') }}">
                                        </div>
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul class="list list-group list-group-flush mb-0">
                            <li class="list-group-item" data-id="01">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="contact-name fs-sm mb-1"><a href="#" class="link text-reset">Jonny Stromberg</a></h5>
                                        <p class="contact-born text-muted mb-0">New updates for ABC Theme</p>
                                    </div>

                                    <div class="flex-shrink-0 ms-2">
                                        <div class="fs-2xs text-muted">06 min</div>
                                    </div>
                                </div>
                            </li>
                            <!-- end list item -->
                            <li class="list-group-item" data-id="02">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="contact-name fs-sm mb-1"><a href="#" class="link text-reset">Jonas Arnklint</a></h5>
                                        <p class="contact-born text-muted mb-0">Bug Report - abc theme</p>
                                    </div>
                                    <div class="flex-shrink-0 ms-2">
                                        <div class="fs-2xs text-muted">12 min</div>
                                    </div>
                                </div>
                            </li>
                            <!-- end list item -->
                            <li class="list-group-item" data-id="03">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="contact-name fs-sm mb-1"><a href="#" class="link text-reset">Martina Elm</a></h5>
                                        <p class="contact-born text-muted mb-0">Nice to meet you</p>
                                    </div>
                                    <div class="flex-shrink-0 ms-2">
                                        <div class="fs-2xs text-muted">28 min</div>
                                    </div>
                                </div>
                            </li>
                            <!-- end list item -->
                            <li class="list-group-item" data-id="04">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="contact-name fs-sm mb-1"><a href="#" class="link text-reset">Gustaf Lindqvist</a></h5>
                                        <p class="contact-born text-muted mb-0">I've finished it! See you so</p>
                                    </div>
                                    <div class="flex-shrink-0 ms-2">
                                        <div class="fs-2xs text-muted">01 hrs</div>
                                    </div>
                                </div>
                            </li>
                            <!-- end list item -->
                        ...
                        <ul class="list list-group list-group-flush mb-0">
                            <li class="list-group-item">
                                <div class="d-flex align-items-center pagi-list">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="fs-base mb-1"><a href="#" class="link text-reset">Jonny Stromberg</a></h5>
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center pagi-list">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="fs-base mb-1"><a href="#" class="link text-reset">Jonas Arnklint</a></h5>
                                        <p class="born fs-xs timestamp text-muted mb-0">Backend Developer</p>
                                    </div>
                                    <div class="flex-shrink-0 ms-2">
                                        <div>
                                            <button type="button" class="btn btn-sm btn-light"><i class="ri-mail-line align-bottom"></i> Message</button>
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center pagi-list">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="fs-base mb-1"><a href="#" class="link text-reset">Martina Elm</a></h5>
                                        <p class="born fs-xs timestamp text-muted mb-0">UI/UX Designer</p>
                                    </div>
                                    <div class="flex-shrink-0 ms-2">
                                        <div>
                                            <button type="button" class="btn btn-sm btn-light"><i class="ri-mail-line align-bottom"></i> Message</button>
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center pagi-list">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="fs-base mb-1"><a href="#" class="link text-reset">Gustaf Lindqvist</a></h5>
                                        <p class="born fs-xs timestamp text-muted mb-0">Full Stack Developer</p>
                                    </div>
                                    <div class="flex-shrink-0 ms-2">
                                        <div>
                                            <button type="button" class="btn btn-sm btn-light"><i class="ri-mail-line align-bottom"></i> Message</button>
