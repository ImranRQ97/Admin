        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="live-preview">
                    <div>
                        <div>
                            <h5 class="fs-sm mb-3">Border width</h5>
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-6">
                                <div>
                                    <h5 class="fs-sm mb-3">Additive</h5>
                                    <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div>
                                    <h5 class="fs-sm mb-3">Subtractive</h5>
                                    <div class="row">
                                        <div class="col-xl-2 col-sm-4 col">
                                            <div class="text-center">
                        ...
                        <div class="mt-4">
                            <h5 class="fs-sm mb-3">Border Color</h5>
                            <div class="d-flex align-items-start flex-wrap gap-4">
                                <div class="text-center">
                        ...
                        <div class="row mt-4">
                            <div class="col-xxl-6">
                                <div>
                                    <h5 class="fs-sm mb-3">Border Style</h5>
                                    <div class="d-flex align-items-start flex-wrap gap-4">
                                        <div class="text-center">
                            ...
                            <div class="col-xxl-5">
                                <div>
                                    <h5 class="fs-sm mb-3">Responsive Border</h5>
                                    <div class="d-flex align-items-start flex-wrap gap-4">
                                        <div class="text-center">
                                            <div class="border border-primary border-dotted border-bottom-lg-0 avatar-md bg-light mx-auto mb-1"></div>
                                            <p><code>.border-bottom-lg-0</code></p>
                                        </div>
                                        <div class="text-center">
                                            <div class="border border-secondary border-end-lg-0 border-dashed avatar-md bg-light mx-auto mb-1"></div>
                                            <p><code>.border-end-lg-0</code></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!--end row-->
                        <div class="mt-4">
                            <h5 class="fs-sm mb-3">Border Opacity</h5>
                            <div class="d-flex align-items-start flex-wrap gap-4">
                                <div class="text-center">
                ...
                <div class="live-preview">
                    <div>
                        <div>
                            <div class="d-flex align-items-start flex-wrap gap-4">
                                <div class="text-center">
                                    <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-md rounded" alt="rounded">
                                    <p><code>.rounded</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-md rounded-top" alt="rounded-top">
                                    <p><code>.rounded-top</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-md rounded-end" alt="rounded-end">
                                    <p><code>.rounded-end</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-md rounded-bottom" alt="rounded-bottom">
                                    <p><code>.rounded-bottom</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-md rounded-start" alt="rounded-start">
                                    <p><code>.rounded-start</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-md rounded-circle" alt="rounded-circle">
                                ...
                                <div class="text-center">
                                    <img src="{{ URL::asset('build/images/small/img-2.jpg') }}" class="avatar-md w-auto rounded-pill" alt="rounded-pill">
                                    <p><code>.rounded-pill</code></p>
                                </div>
                            </div>
                        </div>
                        <div>
                            <h5 class="fs-sm mb-3">Sizes</h5>
                            <div class="d-flex align-items-start flex-wrap gap-4">
                                <div class="text-center">
                                    <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-md rounded-0" alt="rounded-0">
                                    <p><code>.rounded-0</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-md rounded-1" alt="rounded-1">
                                    <p><code>.rounded-1</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-md rounded-2" alt="rounded-2">
                                    <p><code>.rounded-2</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-md rounded-3" alt="rounded-3">
                                    <p><code>.rounded-3</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-md rounded-4" alt="rounded-4">
                                    <p><code>.rounded-4</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-md rounded-5" alt="rounded-5">
                ...
                <div class="live-preview">
                    <div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div>
                                    <h5 class="fs-sm mb-3">Display classes</h5>
                            ...
                            <div class="col-lg-6">
                                <div>
                                    <h5 class="fs-sm mb-3">Hiding elements</h5>
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            <thead class="table-light">
                                                <tr>
                    ...
                    <div class="mt-4">
                        <h5 class="fs-sm">Display in print</h5>
...
<div class="row">
    <div class="col-xxl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Stacks - Vertical</h4>
            </div><!-- end card header -->
            <div class="card-body">
                ...
                <div>
                    ...
                    <div class="mt-5">
                        <h5 class="fs-md mb-3">Vertical Stacks Examples</h5>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xxl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Stacks - Horizontal</h4>
            </div><!-- end card header -->
            <div class="card-body">
                ...
                <div>
                    ...
                    <div class="mt-5">
                        <h5 class="fs-sm mb-3">Horizontal Stacks Examples</h5>
                        <div class="hstack gap-3">
            ...
            <div class="card-body">
                <pre class="language-markup" style="height: 220px;"><code>&lt;!-- Stacks - Horizontal --&gt;
&lt;div class=&quot;hstack gap-3&quot;&gt;
    &lt;div class=&quot;bg-light border p-1 px-2&quot;&gt;First item&lt;/div&gt;
    &lt;div class=&quot;bg-light border p-1 px-2&quot;&gt;Second item&lt;/div&gt;
    &lt;div class=&quot;bg-light border p-1 px-2&quot;&gt;Third item&lt;/div&gt;
...
<div class="row">
    <div class="col-xxl-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Object Fit</h4>
            </div><!-- end card header -->

            <div class="card-body">
                <p class="text-muted mb-3">Use the object fit utilities to modify how the content of a replaced element, such as an <code>&lt;img&gt;</code> or <code>&lt;video&gt;</code>, should be resized to fit its container.</p>
                <div class="row g-4">
                    <div class="col-lg col-md-6">
                        <div class="text-center">
                            <img src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="" height="230" width="200" class="rounded object-fit-cover">
                            <p class="mt-2 mb-0"><code>.object-fit-cover</code></p>
                        </div>
                    </div>
                    <div class="col-lg col-md-6">
                        <div class="text-center">
                            <img src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="" height="230" width="200" class="rounded object-fit-contain border">
                            <p class="mt-2 mb-0"><code>.object-fit-contain</code></p>
                        </div>
                    </div>
                    <div class="col-lg col-md-6">
                        <div class="text-center">
                            <img src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="" height="230" width="200" class="rounded object-fit-fill border">
                            <p class="mt-2 mb-0"><code>.object-fit-fill</code></p>
                        </div>
                    </div>
                    <div class="col-lg col-md-6">
                        <div class="text-center">
                            <img src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="" height="230" width="200" class="rounded object-fit-scale border">
                            <p class="mt-2 mb-0"><code>.object-fit-scale</code></p>
                        </div>
                    </div>
                    <div class="col-lg col-md-6">
                        <div class="text-center">
                            <img src="{{ URL::asset('build/images/small/img-3.jpg') }}" alt="" height="230" width="200" class="rounded object-fit-none">
                            <p class="mt-2 mb-0"><code>.object-fit-none</code></p>
                        </div>
                    </div>
                </div>
            </div><!-- end card-body -->
            ...
            <div class="card-body">
                <pre class="language-markup"><code>&lt;!-- Object Fit --&gt;
&lt;img src=&quot;build/images/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-cover&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-contain&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-fill&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-scale&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-none&quot;&gt;</code></pre>
            </div>
        </div><!-- end card -->
    </div>
</div>
...
<div class="row">
    <div class="col-xxl-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Z-index</h4>
            </div><!-- end card header -->

            <div class="card-body">
                <p class="text-muted mb-3">Use our low-level <code>z-index</code> utilities to quickly change the stack level of an element or component.</p>
                <div class="position-relative z-1">
                    <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" alt="" class="avatar-xxl rounded position-relative z-n1">
                    <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" alt="" class="avatar-xxl rounded position-relative z-0 ms-n5 mt-5">
                    <img src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" alt="" class="avatar-xxl rounded position-relative z-1 ms-n5">
                    <img src="{{ URL::asset('build/images/users/avatar-4.jpg') }}" alt="" class="avatar-xxl rounded position-relative z-2 ms-n5 mt-5">
                    <img src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" alt="" class="avatar-xxl rounded position-relative z-3 ms-n5">
                </div>
            </div><!-- end card-body -->
            <div class="card-body bg-light border-bottom border-top bg-opacity-25">
                <h5 class="fs-xs text-muted mb-0">HTML Preview</h5>
            ...
            <div class="card-body">
                <pre class="language-markup"><code>&lt;!-- z-index --&gt;
&lt;img src=&quot;build/images/users/avatar-1.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-n1&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-2.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-0 ms-n5 mt-5&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-3.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-1 ms-n5&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-4.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-2 ms-n5 mt-5&quot;&gt;</code>

<code>&lt;img src=&quot;build/images/users/avatar-5.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-3 ms-n5&quot;&gt;</code></pre>
            </div>
        </div><!-- end card -->
    </div>
</div>
...
<div class="row">
    <div class="col-xxl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Text Selection</h4>
            </div><!-- end card header -->
            ...
            <div class="card-body">
                <pre class="language-markup" style="height: 125px;"><code>&lt;!-- Text Selection --&gt;
...
<code>&lt;p class=&quot;user-select-none mb-0&quot;&gt;This paragraph will not be selectable when clicked by the user.&lt;/p&gt;</code></pre>
    ...
    <div class="col-xxl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Pointer Events</h4>
            </div><!-- end card header -->
            <div class="card-body">
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Overflow</h4>
            </div><!-- end card header -->
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-sm-6">
                            <div class="mt-4 mt-xl-0">
                                <h5 class="fs-sm">Overflow Auto</h5>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="mt-4 mt-xl-0">
                                <h5 class="fs-sm">Overflow Hidden</h5>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="mt-4 mt-xl-0">
                                <h5 class="fs-sm">Overflow Visible</h5>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="mt-4 mt-xl-0">
                                <h5 class="fs-sm">Overflow Scroll</h5>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
                ...
                <div>
                    <div class="row">
                        <div class="col-xl-4 col-sm-6">
                            <div>
                                <h5 class="fs-sm">Arrange elements</h5>
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="mt-4 mt-sm-0">
                                <h5 class="fs-sm mb-4">Center elements</h5>
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="mt-4 mt-sm-0">
                                <h5 class="fs-sm">Center elements</h5>
            ...
            <div class="card-body">
                <pre class="language-markup" style="height: 250px;"><code>&lt;!-- Arrange elements --&gt;
&lt;div class=&quot;position-relative p-5 bg-light m-3 border rounded&quot; style=&quot;height: 180px;&quot;&gt;
    &lt;div class=&quot;position-absolute top-0 start-0 avatar-xs bg-dark rounded&quot;&gt;&lt;/div&gt;
    &lt;div class=&quot;position-absolute top-0 end-0 avatar-xs bg-dark rounded&quot;&gt;&lt;/div&gt;
    &lt;div class=&quot;position-absolute top-50 start-50 avatar-xs bg-dark rounded&quot;&gt;&lt;/div&gt;
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Shadows</h4>
            </div><!-- end card header -->
...
<code>&lt;div class=&quot;w-auto p-3 bg-light&quot;&gt;Width auto&lt;/div&gt;</code></pre>
    ...
    <div class="col-xxl-6">
        <div class="card">
            ...
            <div class="card-body">
                <pre class="language-markup"><code>&lt;!-- Height --&gt;
