        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mt-4 align-items-end">
                    ...
                    <div class="col-lg-6">
                        <div id="session_chart" data-colors='["--tb-primary", "--tb-secondary"]' class="apex-charts m-n3 mt-n4"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-9">
        <div class="card card-height-100">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        <div id="world-map-line-markers" data-colors='["--tb-light"]' dir="ltr" style="height: 340px"></div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-4">
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-borderless table-centered table-nowrap mb-0">
                        <thead class="text-muted table-light">
                            <tr>
                                <th scope="col" class="sort cursor-pointer" data-sort="activePage">Active Page</th>
