    ...
    <div class="col-lg-3">
        <div class="card real-estate-grid-widgets card-animate">
            <div class="card-body p-2">
                <img src="{{ URL::asset('build/images/real-estate/img-01.jpg') }}" alt="" class="img-fluid rounded mx-auto d-block">
...
<script src="{{ URL::asset('build/js/pages/real-estate-add-property.init.js') }}"></script>
